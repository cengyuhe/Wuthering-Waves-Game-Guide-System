            ...
            data.forEach(weapon => {
                ...
                htmlContent += `
                    <div class="card ${rarityClass}" onclick="openWeaponPage(${weaponJson})">
                        <img src="../images/${weapon.image_url}" loading="lazy" onerror="this.src='../images/default_weapon.jpg'">
                        <div class="card-info">
                            <h3>${weapon.name}</h3>
                        </div>
                    </div>
...
function openWeaponPage(weapon, updateHistory = true) {
    ...
    display.innerHTML = `
        <div class="wp-detail-container">
            <div class="wp-detail-content">
                <div class="wp-detail-left">
                    <div class="wp-large-img-box" style="border-color: ${borderColor};">
        ...
        🤍
            ...
            <div class="wp-section-block">
                ...
                <div class="wp-card-box">
                    ...
                    <div class="wp-card-body" id="wp-skill-body"></div>
                </div>
            </div>
            <div class="wp-section-block wp-bg-section">
                <h3>Background</h3>
...
function updateWeaponLevel(newLevel) {
    ...
    if (lvl < 41) { currentMat1Name = m1t1; currentMat2Name = m2t1; } 
    else if (lvl >= 41 && lvl < 61) { currentMat1Name = m1t2; currentMat2Name = m2t2; } 
    else if (lvl >= 61 && lvl < 81) { currentMat1Name = m1t3; currentMat2Name = m2t3; } 
    else if (lvl >= 81) { currentMat1Name = m1t4; currentMat2Name = m2t4; }
    ...
    if (lvl < 21) { mat1 = 0; mat2 = 0; mat3 = 0; } 
    else if (lvl >= 21 && lvl < 41) { mat1 = 0; mat2 = 6; mat3 = 10000; } 
    else if (lvl >= 41 && lvl < 51) { mat1 = 6; mat2 = 6; mat3 = 20000; } 
    else if (lvl >= 51 && lvl < 61) { mat1 = 8; mat2 = 4; mat3 = 40000; } 
    else if (lvl >= 61 && lvl < 71) { mat1 = 6; mat2 = 6; mat3 = 60000; } 
    else if (lvl >= 71 && lvl < 81) { mat1 = 8; mat2 = 4; mat3 = 80000; } 
    else if (lvl >= 81) { mat1 = 12; mat2 = 8; mat3 = 120000; }
